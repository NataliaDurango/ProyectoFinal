...
include('Usuario.php'); /* Conexion de las recetas */
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            while ($usuarios= mysqli_fetch_object($todosRegistros)){
                ...
                echo "<div class='center'> <a class='btn btn-success' href='". ROOT ."/Usuario/edit.php?id=$usuarios->id' >Modificar</a> - <a class='btn btn-danger' href='". ROOT ."/Usuario/index.php?id=$usuarios->id' >Eliminar</a> </div>";
